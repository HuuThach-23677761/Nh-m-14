...
CREATE TABLE HOCVIEN (
    MAHV VARCHAR(20) PRIMARY KEY,  -- MAHV
    HOTEN NVARCHAR(100),
    NGAYSINH DATE,
...
CREATE TABLE LOP (
    MALOP VARCHAR(20) PRIMARY KEY,  -- MALOP
    MAHV VARCHAR(20),
    TENLOP NVARCHAR(100),
    THOIKHOABIEU NVARCHAR(100),
    NGAYKHAIGIANG DATE,
    HOCPHI DECIMAL(10, 2),
    LOAILOP NVARCHAR(20), -- "ngan han" hoặc "dai han"
...
CREATE TABLE MONHOC (
    MAMH VARCHAR(20) PRIMARY KEY,  -- MAMH
...
('L001', N'Lớp Java cơ bản', 'T2-T4-T6', '2025-06-01', 2000000, N'ngắn hạn'),
('L002', N'Lớp SQL nâng cao', 'T3-T5', '2025-06-05', 2500000, N'dài hạn'),
('L003', N'Lớp Python', 'T2-T4', '2025-06-10', 2200000, N'ngắn hạn'),
('L004', N'Lớp C#', 'T7-CN', '2025-06-15', 2300000, N'dài hạn'),
('L005', N'Lớp HTML/CSS', 'T2-T5', '2025-06-20', 1800000, N'ngắn hạn')
-- Học viên
...
('HV06', 'Nguyễn Xuân Hoan', '2005-02-03', 'Gia Lai', 'Nam', 'Giáo viên', 'L004');
-- Môn học
